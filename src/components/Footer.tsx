    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-gray-400 -mt-1">Extraordinary Amenities</span>
              </div>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Discover luxury hotels with extraordinary amenities like padel courts,
              in-room hot tubs, private pools, and exclusive facilities worldwide.
            </p>
          ...
          {/* Hotel Categories */}
          <div>
            <h3 className="text-lg font-semibold mb-6">Hotel Categories</h3>
            <ul className="space-y-3">
              <li>
